...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|------+-------+--------+--------+--------+------|                     |--------+-------+--------+--------+--------+---------|
LCTL_T(KC_ESC),KC_A,    KC_S,    KC_D,    KC_F,  KC_G,                        KC_H,    KC_J,   KC_K,    KC_L,    LT(_NAV, KC_SCLN), KC_ENT,
  //|------+-------+--------+--------+--------+------|  ===  |     |  ===  |--------+-------+--------+--------+--------+---------|
    KC_LSFT,   KC_Z,    KC_X,    KC_C,    KC_V,  KC_B, KC_MUTE,      TG(_GAME),   KC_N,    KC_M,   KC_COMM, KC_DOT,  KC_SLSH, RSFT_T(KC_QUOT),
  //|------+-------+--------+--------+--------+------|  ===  |     |  ===  |--------+-------+--------+--------+--------+---------|
                     LCTL(KC_LSFT), KC_LALT, KC_LGUI,KC_SWEDE, KC_SPC, KC_SPC, KC_SYMBOLS, KC_UNDS, KC_DOWN, KC_UP
  //               \--------+--------+--------+------+-------|     |--------+---------+--------+---------+-------/
),
...
[_SWEDE] = LAYOUT(
  ...
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
  _______,    KC_P0,  KC_P1,    KC_P2,   KC_P3, _______,_______,_______, _______, SQ_PATH, LGUI(KC_MINS), LGUI(KC_PLUS),   KC_BSLS, KC_GRV,
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
...
[_SYMBOLS] = LAYOUT(
  ...
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
                 _______, _______, _______, _______, _______,     _______, _______, _______, KC_LEFT, KC_RIGHT
  //            \--------+--------+--------+---------+-------|   |--------+---------+--------+---------+-------/
),
...
[_GAME] = LAYOUT(
  ...
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
              _______, _______, _______, KC_SPC, KC_SWEDE,   _______, _______,_______,  _______, _______
  //            \--------+--------+--------+---------+-------|   |--------+---------+--------+---------+-------/
),
...
[_NAV] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, _______,                   _______, _______,  _______, _______,_______, _______,
  //|------+-------+--------+--------+--------+------|                   |--------+-------+--------+--------+--------+---------|
  _______, _______, LCTL(KC_LEFT), LCTL(KC_UP), LCTL(KC_UP), _______,      KC_LEFT, KC_DOWN,  KC_UP, KC_RIGHT,_______, _______,
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
  _______, _______, _______, _______, _______, _______,_______,   _______,_______, _______,  _______, _______,_______, _______,
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
...
[_FKEYS] = LAYOUT(
  ...
  _______,  _______, _______, _______, _______, _______,                   _______,_______, _______, _______, _______, _______,
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
  _______,  _______, _______, _______, _______,_______,_______,   _______, _______, _______, _______, _______, _______, MO(_QMKSTUFF),
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
                   _______, _______, _______, _______, _______,     _______, _______, _______, _______, _______
    //            \--------+--------+--------+---------+-------|   |--------+---------+--------+---------+-------/
),
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    switch (keycode) {
        ...
        case KC_SWEDE:
            if (record->event.pressed) {
                layer_on(_SWEDE);
                update_tri_layer(_SWEDE, _SYMBOLS, _FKEYS);
            } else {
                layer_off(_SWEDE);
                update_tri_layer(_SWEDE, _SYMBOLS, _FKEYS);
            }
