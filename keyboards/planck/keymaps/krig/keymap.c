...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_planck_grid(
      ...
      _______,        _______,         KC_UNDS,    _______, _______,    _______,  _______, KC_UNDS,    _______, _______,  RALT(KC_Q), RALT(KC_P),
  ...
  [_GAME] = LAYOUT_planck_grid(
      _______,        _______,         _______,    _______, _______,    _______,  _______, _______,    _______,  _______,    _______,    KC_F3,
