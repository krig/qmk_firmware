...
[_BASE] = LAYOUT(
    ...
    MO(_NUMERIC), KC_LSHIFT,       KC_Z,             KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_QUOTE,
    TG(_GAME), LCTL(KC_LALT),  LCTL(KC_LSHIFT), KC_LALT, KC_LGUI,   LOWER,  KC_SPC,            RAISE,    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
