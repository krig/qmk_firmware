...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_wrapper(
      ...
      WS_PREV, OSM_SFT,    QWERTY_L3,    QWERTY_R3, KC_RSFT,
       QK_REP, CW_TOGG, CTL_SFT, KC_LALT, KC_LGUI, THUMB_L2,  KC_SPC,          THUMB_R2, KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT
    ),
    ...
    [_RAISE] = LAYOUT_wrapper(
      _______, _______, SYMBOLS_L1, SYMBOLS_R1, KC_INS,
      _______, _______, SYMBOLS_L2, SYMBOLS_R2, _______,
      _______, _______, SYMBOLS_L3, SYMBOLS_R3, KC_GRV,
